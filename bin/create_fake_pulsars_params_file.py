...
SUPPORTED_SNR_VARIATION_TYPES = ['uniform', 'slope', 'random']
...
if __name__ == '__main__':
    ...
    a.add_argument('-p0', type=float, help="Period of the simulated pulsar required [seconds] (default = 10.0)", default=10.0)
    a.add_argument('-p0_samps', type=float, help="Periond of the simulated pulsar [samps] (def=100)")

    a.add_argument('-snr', type=float, help = "Desired SNR of the pulsar after folding (def = 20)", default=20)
    a.add_argument('-snr_variation', type=str, help="Type of pulse-to-pulse variation -- supported types: uniform, slope, random, def=unifrom", default="uniform")
