...
if __name__ == '__main__':
    ...
    a.add_argument('-dm', type=float, nargs=2, help = "DM range endpoints [pc/cc] (e.g. 10, 12; def=0,0)", default=[0, 0])
    a.add_argument('-width', type=float, nargs=2, help = "width range endpoints [s] (e.g. 0.0001, 0.0002; def=0.0017,0.0017)", default=[0.0017, 0.0017])
    ...
    a.add_argument('-ra', type=float, nargs=2, help="Injection RA range", default=[0.0, 0.0])
    a.add_argument('-dec', type=float, nargs=2, help="Injection DEC range", default=[-30.0, -30.0])
